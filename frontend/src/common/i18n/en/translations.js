export const TRANSLATIONS_EN = {
    ...
    PageTitles: {
        ...
        userRecommendations: "My Recommendations",
        userTrips: "My Trips",
    ...
    Navbar: {
        ...
        recommendations: "My recommended",
        logout: "Log out",
    ...
    Experience: {
        ...
        toast: {
            ...
            favError: "Server error adding '{{experienceName}} to favourites'",
            noFavError: "Server error removing '{{experienceName}}' to favourites",
            ...
            recommendedSuccess: "'{{experienceName}}' was recommended",
            noRecommendedSuccess: "{{experienceName}}' was removed from your recommended",
            recommendedError: "Server error adding '{{experienceName}}' to recommended",
            noRecommendedError: "Server error removing '{{experienceName}}' to recommended",
        },
    },
    ...
    User: {
        ...
        recommendedTitle: "My recommended",
        noRecommended: "You haven't recommended any experience yet",
    ...
    Order: {
        ...
        OrderByAZ: "A-Z",
        OrderByZA: "Z-A",
        OrderByRankAsc: "Lower score",
        OrderByRankDesc: "Higher score",
        OrderByLowPrice: "Lower price",
        OrderByHighPrice: "Higher price",
        OrderByViewsAsc: "Lower views",
        OrderByViewsDesc: "Higher views",
        OrderByNewest: "Last added", 
        OrderByOldest: "First added",
        OrderByPendings: "First pendings",
        OrderByApproved: "First approved",
        OrderByFavsAsc: "Lower favs",
        OrderByFavsDesc: "Higher favs",
    },
    ...
    Review: {
        ...
        toast: {
            ...
            alreadyCreate: "You have already create a review to this experience",
            forbidden: {
    ...
    Testimonial: {
        ...
        toast: {
            ...
            alreadyCreate: "You have already create a testimonial to this agent",
            forbidden: {
    ...
    Trips: {
        ...
        noExperiences: "You haven't add any experience to your trip yet",
        toast: {
            createSuccess: "'{{title}}' created successfully!",
            createError: "Server error creating trip '{{title}}'",
            updateSuccess: "'{{title}}' updated successfully!",
            updateError: "Server error updating trip '{{title}}'",
            deleteSuccess: "'{{title}}' deleted successfully",
            deleteError: "Server error deleting trip '{{title}}'",
        },
        dropdown: {
